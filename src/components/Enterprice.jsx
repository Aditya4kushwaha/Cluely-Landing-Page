export default function EnterpriseSection() {
  return (
    <>
      <div id="enterprice" className="w-full bg-[#E1E4EF] pt-0 pb-12 sm:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="p-6 sm:p-8 md:p-12 lg:p-16">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
              ...
              <div className="flex-shrink-0 mt-6 lg:mt-0 w-full sm:w-auto">
                <button className="cursor-pointer w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-400 to-blue-500 text-white font-semibold rounded-lg shadow-lg shadow-blue-500/40 hover:opacity-90 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                  Talk to sales
                </button>
              </div>
            </div>
